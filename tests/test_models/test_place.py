...
class TestPlace_init(unittest.TestCase):
    ...
    def test_city_id_is_pub_class_attr(self):
        pl = Place()
        self.assertEqual(str, type(Place.city_id))
        self.assertIn("city_id", dir(pl))
        self.assertNotIn("city_id", pl.__dict__)

    def test_user_id_is_pub_class_attr(self):
        pl = Place()
    ...
    def test_str_repr(self):
        ...
        plstr = pl.__str__()
        self.assertIn("[Place] (146)", plstr)
        self.assertIn("'id': '146'", plstr)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        pl = Place(id="67", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(pl.id, "67")
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_dt_attr_are_str(self):
        pl = Place()
        pl_dict = pl.to_dict()
