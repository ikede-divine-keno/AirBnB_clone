...
class TestState_init(unittest.TestCase):
    ...
    def test_new_inst_storedin_obj(self):
    ...
    def testname_is_pub_class_attr(self):
        s = State()
    ...
    def test_twostates_diff_created_at(self):
        s1 = State()
        sleep(0.03)
        s2 = State()
        self.assertLess(s1.created_at, s2.created_at)

    def test_twostates_diff_updated_at(self):
        s1 = State()
        sleep(0.03)
        s2 = State()
    ...
    def test_str_repr(self):
        ...
        ststr = s.__str__()
        self.assertIn("[State] (147)", ststr)
        self.assertIn("'id': '147'", ststr)
    ...
    def test_init_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        s = State(id="36", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(s.id, "36")
